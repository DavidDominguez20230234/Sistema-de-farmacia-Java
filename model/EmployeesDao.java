...
public class EmployeesDao {
    ...
    public boolean registerEmployeeQuery(Employees employee){
        String query = "INSERT INTO employees (id, fullname, username, address, telephone, email, password, rol, created, "
                + "updated) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public boolean updateEmployeeQuery(Employees employee){
        String query = "UPDATE employees SET fullname = ?, username = ?, address = ?, telephone = ?, email = ?, rol = ?, updated = ? "
                + "WHERE id = ?";
    ...
    public boolean deleteEmployeeQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "El empleado tiene relación con otra tala, no es posible eliminarlo");
            return false;
        }
    }
